  # Code from https://github.com/cchen22/TIGER/blob/master/R/TIGER.R
  ...
  prior <- read.csv("prior_t.csv")
  rownames(prior) = prior[,1]
  R <- TIGER(expr[,colnames(expr)[-1]], prior[,colnames(prior)[-1]])